        ...
        {[
          ...
          <motion.div
            ...
            style={{
              left: tech.left,
              top: tech.top,
              y: i % 3 === 0 ? floatY1 : i % 3 === 1 ? floatY2 : floatY3,
            }}
            animate={{
              y: [0, -15 - (i % 4) * 5, 0, 10 + (i % 3) * 3, 0],
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill={tech.color}
              style={{ opacity: 0.6, filter: `drop-shadow(0 0 8px ${tech.color}40)` }}
            >
              <path d={tech.path} />
            </svg>
          </motion.div>
