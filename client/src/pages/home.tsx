    ...
    <div className="min-h-screen bg-dark-primary text-text-primary relative">
      ...
      >
        ...
        {[
          ...
          { name: "CSS3", left: "42%", top: "8%", size: 44, color: "#264DE4", path: "M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.002l5.355-1.12.814-9.056h-5.11l5.5-.013.03-4.399z" },
          { name: "HTML5", left: "55%", top: "85%", size: 46, color: "#E34F26", path: "M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.071-.787.168-1.873.012-.128H4.66l.794 8.73h7.576l-.336 3.528-1.703.463-1.683-.464-.105-1.194H6.59l.213 2.455 4.17 1.14h.012l4.151-1.14.543-5.77.06-.609.021-.234H8.53z" },
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill={tech.color}
              style={{ opacity: 1, filter: `drop-shadow(0 0 12px ${tech.color}80)` }}
            >
              <path d={tech.path} />
            </svg>
          </motion.div>
