...
export class MemStorage implements IStorage {
  ...
  async trackVisitor(insertVisitor: InsertVisitor): Promise<Visitor> {
    ...
    const visitor: Visitor = { 
      ...
      address: insertVisitor.address || null,
      postalCode: insertVisitor.postalCode || null,
      latitude: insertVisitor.latitude || null,
      longitude: insertVisitor.longitude || null,
      nearbyBusinesses: insertVisitor.nearbyBusinesses || null,
      currentBusiness: insertVisitor.currentBusiness || null,
